        ...
        <div class="admin-content">
            ...
            <div class="onglets">
                <?php foreach ($types as $t):
                    ...
                    $classe_couleur = $classesType[$t['nom_type']] ?? 'onglet-defaut';
                    $actif = ((int)$t['id_type'] === $idTypeActif) ? 'actif' : '';
                ?>
                    <a href="index.php?action=admin-services&type=<?php echo (int)$t['id_type']; ?>" class="onglet-btn <?php echo $classe_couleur; ?> <?php echo $actif; ?>">
            ...
            <section class="add-pharmacy-section">
                <h2>Ajouter un(e) <?php echo htmlspecialchars(array_values(array_filter($types, fn($t) => (int)$t['id_type'] === $idTypeActif))[0]['nom_type']); ?></h2>

                <form method="post" action="index.php?action=admin-services">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="actions-cell" data-label="Actions">
                                        ...
                                        <form method="post" action="index.php?action=admin-services" class="inline-form">
                                        ...
                                        <form method="post" action="index.php?action=admin-services" class="inline-form" onsubmit="return confirm('Supprimer ce service ?');">
...
<style>
    ...
    .onglet-pharmacie, .onglet-pompier, .onglet-police { border: none; }
